...
function TwoFactorVerifyLogin({ user, username, onLoginSuccess }) {
  ...
  return (
    <div className="relative w-full max-w-md bg-[#2e1048]/95 backdrop-blur-md p-8 md:p-10 rounded-3xl shadow-2xl border border-purple-500/30 text-white z-10">
      <h2 className="text-2xl font-extrabold mb-1 text-center text-white tracking-wide">
      ...
      <form onSubmit={handleVerifyLogin} className="space-y-5">
        <div>
          <p className="block text-xs font-bold text-white uppercase tracking-wider mb-2 text-center">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-full bg-[#1b082d]/70 border border-purple-500/40 text-white text-center tracking-[0.5em] text-xl placeholder-purple-400/40 focus:outline-none focus:ring-2 focus:ring-orange-500 shadow-inner"
            autoFocus
          />
        </div>
