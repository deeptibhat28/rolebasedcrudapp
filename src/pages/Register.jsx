    ...
    return (
      ...
      >
        <div className="relative w-full max-w-md bg-[#240b3b] backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-purple-500/30 text-center z-10">
          ...
          <button
            onClick={() => navigate("/")}
            className="w-full py-3.5 bg-linear-to-r from-orange-500 to-pink-600 hover:opacity-95 text-white font-bold rounded-xl transition duration-200 shadow-lg tracking-wider text-sm uppercase"
          >
