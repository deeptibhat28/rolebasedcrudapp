                ...
                <div className="w-full md:w-1/2 flex justify-end z-10">
                    <div className="bg-white/10 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-md border border-white/10">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-xs text-purple-200/70 mt-1">Sign up to get started</p>
                        </div>

                        <form onSubmit={handleRegister} className="space-y-4">
                            <div>
                                <label className="block text-xs font-semibold text-purple-200 uppercase tracking-wider mb-2">Username</label>
                                <input 
                                    type="text"
                                    value={username}
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-purple-200 uppercase tracking-wider mb-2">Password</label>
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-purple-200 uppercase tracking-wider mb-2">Account Role</label>
                                <select
                                    value={role}
                            ...
                            <button type="submit" className="w-full py-3 bg-linear-to-r from-red-500 to-orange-500 hover:opacity-95 text-white font-semibold rounded-lg transition duration-200 shadow-lg tracking-wide text-sm mt-2">
                                Register Now
                            </button>
                        </form>

                        <p className="text-center text-sm text-purple-200/70 mt-6">
                            Already have an account? <Link to="/" className="text-white font-bold hover:underline">Sign In</Link>
                        </p>
                    </div>
                </div>
