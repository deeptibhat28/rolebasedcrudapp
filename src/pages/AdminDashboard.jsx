...
export default function AdminDashboard() {
  ...
  const confirmDelete = async () => {
    try {
      ...
      console.log("Deleting submission with ID:", actualId);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center bg-[#2e1048]/95 backdrop-blur-md p-6 rounded-3xl shadow-2xl mb-6 border border-purple-500/30 relative z-10">
        <div className="mb-4 md:mb-0">
          ...
          <p className="text-sm text-purple-300/80 mt-0.5">
            ...
            <span className="font-semibold text-lg text-orange-400">{currentUser?.username}</span>
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto bg-[#2e1048]/95 backdrop-blur-md p-6 rounded-3xl shadow-2xl border border-purple-500/30 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
          ...
          <div className="w-full md:w-72">
            <input
              ...
              className="w-full px-4 py-2.5 bg-[#1b082d]/70 border border-purple-500/40 rounded-xl text-xs text-white placeholder-purple-400/50 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-inner transition"
            />
          </div>
        ...
        {submissions.length === 0 ? (
          <p className="text-purple-300/80 text-sm py-4">
                ...
                {currentSubmissions.map((sub) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-2 text-xs text-purple-300/80">
